...
```python
from greennode_agentbase import MemoryClient, IAMCredentials
...
await history_client.createEvent_async(...)
results = await knowledge_client.searchMemoryRecords_async(...)
```
