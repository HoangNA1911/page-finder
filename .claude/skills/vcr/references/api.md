...
**Important**: `repoName` must be unique across all repositories. The API will reject creation if a repo with the same name already exists. Always list repos first (`GET /v1/repository?name=...`) to check for duplicates before creating.
